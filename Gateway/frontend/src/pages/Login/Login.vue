        ...
        <v-col cols="12" lg="5" class="login-part d-flex align-center justify-center">
          <v-row no-gutters class="align-start">
                    ...
                    <v-form>
                      <v-container>
                        <v-row class="flex-column">
                          <v-col>
                            <p class="login-slogan display-2 text-center font-weight-medium my-10">Welcome!</p>
                          ...
                          <v-form>
                            ...
                            <v-col class="d-flex justify-space-between">
                              <v-btn
                                  ...
                                  color="primary"
                                  @click="join({email: createEmail, name: createFullName, password: createPassword})"
                              >
            ...
            <v-col cols="12" class="d-flex justify-center">
              <v-footer>
                <div class="primary--text">© 2022 <a href="http://www.esct.co.kr/" class="text-decoration-none">(주)에스씨티</a>, All rights reserved.</div>
              </v-footer>
            </v-col>
          </v-row>
        </v-col>
...
export default {
  ...
  computed: {
    ...mapState(['isLogin', 'isLoginError', 'joinError', 'errorMessage']),
  }    
}
