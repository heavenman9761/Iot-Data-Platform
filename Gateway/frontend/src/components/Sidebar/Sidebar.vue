<template>
  <v-navigation-drawer
    ...
    <div class="v-list">
      <a class="v-list-item v-list-item--link grey--text text-sm-h6" target="_blank" href="http://www.esct.co.kr">Generate App</a>
    </div>
    ...
    data(){
      return {
        items: [
          ...
          { title: 'Data 설정', icon: 'mdi-access-point-network', link: '/setnotis' },
          { title: 'Dashboard', icon: 'mdi-home', link: '/dashboard' },
          { title: 'ExamDashboard', icon: 'mdi-home', link: '/examdashboard' },
