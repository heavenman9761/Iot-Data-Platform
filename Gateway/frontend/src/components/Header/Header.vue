<template>
  <v-app-bar
    ...
    <v-toolbar-title>IoT Middleware</v-toolbar-title>
    <v-spacer></v-spacer>
    <!-- <v-btn
    ...
    <v-menu
      ...
      nudge-bottom="10">
        ...
        <v-list >
          <div class="text-h5 grey--text text--darken-3 px-4 pt-4">{{ userInfo.name }}</div>
          <div class="subtitle-2 primary--text font-weight-regular px-4">{{ userInfo.userid }}</div>
          <v-list-item-group color="primary">
            <v-list-item
...
export default {
  ...
  methods: {
    ...mapActions([ 'TOGGLE_DRAWER', 'logout' ]),
    // logOut: function () {
